...
기존 89일 train·29일 test를 300일·100일로 늘렸습니다.
...
MISO 월별 ZIP의 일별 보고서 802개에서 `MISO System` 가격을 확인했습니다. 기존 가격과 겹치는 구간은 값이 같았습니다.
